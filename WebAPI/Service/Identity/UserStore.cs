...
namespace Services.Identity
{
    ...
    IUserLockoutStore<ApplicationUser>
    {
        ...
        public UserStore(IUnitOfWorkFactory factory, IMapper mapper)
        {
            _factory = factory;
            _mapper = mapper;
        }
        ...
        private UserData Map(ApplicationUser user)
        {
            return _mapper.Map<ApplicationUser, UserData>(user);
        }

        private ApplicationUser Map(UserData data)
        {
            return _mapper.Map<UserData, ApplicationUser>(data);
        }
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            {
                var data = _mapper.Map<ApplicationUser, UserData>(user);
